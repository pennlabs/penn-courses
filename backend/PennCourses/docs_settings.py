...
class JSONOpenAPICustomTagGroupsRenderer(JSONOpenAPIRenderer):
    def render(self, data_raw, media_type=None, renderer_context=None):
        ...
        for original_kwarg, parameter_name, parameter_dict in [
            ...
            ("override_request_schema", "cumulative_override_request_schema", cumulative_override_request_schema),
            ("override_response_schema", "cumulative_override_response_schema", cumulative_override_response_schema),
            ...
            if param_dict is not None:
                ...
                for dictionary in param_dict.values():
                    ...
                    for nested_dictionary in dictionary.values():
                        ...
                        if param_name in ["examples", "override_request_schema", "override_response_schema"]:
                            continue

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='degree.degree')),
                ('person', models.ForeignKey(help_text='The person (user) to which the degree plan belongs.', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overridden', models.BooleanField(help_text='\nWhether this is an override for one or more requirements.\n')),
                ('course', models.ForeignKey(help_text='\nThe fulfilling course.\n', on_delete=django.db.models.deletion.CASCADE, to='courses.course')),
                ('degree_plan', models.ForeignKey(default=None, help_text='\nThe degree plan this semester plan is a part of.\n', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fulfillments', to='degree.degreeplan')),
                ('fulfilled_requirements', models.ManyToManyField(help_text='\nThe requirement(s) this fulfils.\n', to='degree.degreerequirement')),
            ],
            options={

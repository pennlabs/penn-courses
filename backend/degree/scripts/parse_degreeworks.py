...
E_DEPTS = [
    "BE", "CIS", "CMPE", "EAS", "ESE", "MEAM", "MSE", "NETS", "ROBO"
] # SEAS
A_DEPTS = [
    "AFST", "AMCS", "ANTH", "ARAB", "ARCH", "ARTH", "ASAM", "ASTR", "BIBB", "BIOE", "BIOL", "BIOM", "BMIN", "CAMB", "CHEM", "CHIN", "CIMS", "CINE", "CIS", "CLST", "COLL", "COML", "CRIM", "CSCI", "EALC", "ECON", "ENGL", "ENVS", "FNAR", "FOLK", "FREN", "GDES", "GEOL", "GRMN", "GSWS", "HCMG", "HEBR", "HIST", "HSOC", "IGGS", "INTL", "ITAL", "JPAN", "LALS", "LATN", "LGIC", "LING", "MATH", "MUSC", "NELC", "PHIL", "PHYS", "PPE", "PSCI", "PSYC", "RELS", "RUSS", "SAST", "SOCI", "SPAN", "STAT", "STSC", "SWRK", "TAML", "THAR", "TURK", "URBS", "URDU", "WRIT"
] # SAS
W_DEPTS = [
    "ACCT", "BEPP", "FNCE", "HCMG", "LGST", "MKTG", "OIDD", "REAL", "STAT"
] # Wharton
...
def parse_coursearray(courseArray):
    ...
    for course in courseArray:
        course_q = Q()
        match course["discipline"], course["number"]:
            case "@", "@": # any course
                pass
            case "PSEUDO@", "@":
                pass # TODO: this creates opportunity for q to be empty... is this okay?
            case _, "@":
                ...
                match filter["code"]:
                    ...
                    case "DWCOLLEGE":
                        ...
                        match filter["valueList"][0]:
                            ...
                            case _:
                                raise ValueError(f"Unsupported college in withArray: {filter['valueList'][0]}")                        
                    case _:
                        raise LookupError(f"Unknown filter type in withArray: {filter['code']}")
                match filter["connector"]: # TODO: this assumes the connector is to the next element (ie we use the previous filter's connector here)
                    case "AND" | "":
                        course_q &= sub_q
                    case "OR":
                        course_q |= sub_q
...
def evaluate_condition(condition, degree_plan) -> bool:    
    if "connector" in condition:
        ...
        match comparator["operator"]:
            ...
            case _:
                raise LookupError(f"Unknown relational operator in ifStmt: {comparator['operator']}")        
    else:
    ...
    for rule in ruleArray:
        ...
        match rule["ruleType"]:
            case "Course":
                ...
                rules.append(
                    Rule(q=parse_coursearray(rule_req["courseArray"]), num=1, cus=None)
                )
            case "IfStmt":
                ...
                match rule["booleanEvaluation"]:
                    ...
                    case _:
                        raise LookupError(f"Unknown boolean evaluation in ifStmt: {rule['booleanEvaluation']}")

                assert degreeworks_eval is None or evaluation == bool(int(degreeworks_eval))
...
def parse_degreeworks(json, degree_plan):
...
if __name__ == "__main__":
    ...
    E_BSE_DEGREE_PLANS = [DegreePlan(program='EU_BSE', degree='BSE', major='AFRC', concentration='AAS', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='AFRC', concentration='AFD', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='AFRC', concentration='AFST', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ANTH', concentration='BANT', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ANTH', concentration='MAGH', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='ARCH', concentration='DSGN', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='BIOL', concentration='BMAT', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='BIOL', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='COGS', concentration='NONE', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='COMM', concentration='COP', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='COMM', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='CSCI', concentration='ARIN', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='CSCI', concentration='COGS', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='CSCI', concentration='DATS', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='CSCI', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='EASC', concentration='EVSC', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='EASC', concentration='GEOL', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='EALC', concentration='EAST', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ENGL', concentration='CIMS', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='ENGL', concentration='CMPL', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='ENGL', concentration='CRWR', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ENGL', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='GRMN', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='HSOC', concentration='GLBH', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='HSOC', concentration='PBHC', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='HIST', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ITST', concentration='ITCL', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='ITST', concentration='ITLT', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='ITST', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='MATH', concentration='NONE', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='MEAM', concentration='DCR', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='MEAM', concentration='EFTS', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='MEAM', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='NELC', concentration='ANEN', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='NELC', concentration='AHSN', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='NELC', concentration='AISN', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='NELC', concentration='HEB', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='NELC', concentration='APEN', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='NETS', concentration='DATS', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='NETS', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='PHIL', concentration='HPHI', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='PSCI', concentration='INTR', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='PSCI', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='ROML', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='REES', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BSE', degree='BSE', major='SOCI', concentration='LAWS', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='SOCI', concentration='MDS', year=2023),
        DegreePlan(program='EU_BSE', degree='BSE', major='SOCI', concentration='NONE', year=2023),
    ...
    E_BAS_DEGREE_PLANS = [
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='AFRC', concentration='AFST', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ANTH', concentration='BANT', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ANTH', concentration='MAGH', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ASBS', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ARCH', concentration='DSGN', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='BIOL', concentration='BMAT', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='BIOL', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='COMM', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='EASC', concentration='EVSC', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='EASC', concentration='GEOL', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='EALC', concentration='EAST', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ENGL', concentration='CIMS', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='ENGL', concentration='CRWR', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ENGL', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='HSOC', concentration='GLBH', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='HSOC', concentration='PBHC', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='HIST', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ITST', concentration='ITCL', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='ITST', concentration='ITLT', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='ITST', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='MATH', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='NELC', concentration='ANEN', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='NELC', concentration='AHSN', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='NELC', concentration='AISN', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='NELC', concentration='HEB', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='NELC', concentration='APEN', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='PHIL', concentration='HPHI', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='PSCI', concentration='INTR', year=2023),
        DegreePlan(program='EU_BAS', degree='BAS', major='PSCI', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='ROML', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='REES', concentration='NONE', year=2023),
        ...
        DegreePlan(program='EU_BAS', degree='BAS', major='SOCI', concentration='LAWS', year=2023),
    ...
    for i, degree_plan in enumerate(E_BSE_DEGREE_PLANS):
        print(degree_plan)
        parse_degreeworks(audit(degree_plan), degree_plan)

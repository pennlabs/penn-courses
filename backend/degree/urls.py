...
from degree.views import DegreePlanViewset, DegreeViewset, FulfillmentViewSet, DoubleCountRestrictionViewset, courses_for_rule
...
router.register(r"doublecountrestrictions", DoubleCountRestrictionViewset, basename="doublecountrestriction")

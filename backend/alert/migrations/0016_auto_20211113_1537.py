...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FloatField(blank=True, help_text="The loc parameter of the fitted log-normal distribution on positive raw demand values from closed sections. Null if there are no closed sections that have positive raw demand values. The abbreviation 'csprdv' stands for 'closed section positive raw demand values'.", null=True),
        ),
        migrations.AddField(
            model_name='pcademanddistributionestimate',
        ...
        migrations.AddField(
            ...
            field=models.FloatField(blank=True, help_text="The fraction of closed sections' raw demand values that are 0 (non-positive), expressed as a float in the range [0,1]. Null if there are no closed sections. The abbreviation 'csrdv' stands for 'closed section raw demand values', not to be confused with 'csprdv', which stands for 'closed section positive raw demand values'.", null=True),
        ),

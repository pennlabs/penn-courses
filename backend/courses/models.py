...
class Section(models.Model):
    ...
    status = models.CharField(
        max_length=4, choices=STATUS_CHOICES, db_index=True,
    ...
    activity = models.CharField(
        max_length=50, choices=ACTIVITY_CHOICES, db_index=True,
...
class Meeting(models.Model):
    ...
    """
    section = models.ForeignKey(
        Section, on_delete=models.CASCADE, related_name="meetings",
...
class Requirement(models.Model):
    ...
    school = models.CharField(
        max_length=5, choices=SCHOOL_CHOICES, db_index=True,
        help_text=dedent("""
    ...
    departments = models.ManyToManyField(
        Department, related_name="requirements", blank=True,
        help_text=dedent("""
    ...
    courses = models.ManyToManyField(
        Course, related_name="requirement_set", blank=True,
        help_text=dedent("""
    ...
    overrides = models.ManyToManyField(
        Course, related_name="nonrequirement_set", blank=True,
        help_text=dedent("""
...
class UserProfile(models.Model):
    ...
    phone = models.CharField(
        blank=True, null=True, max_length=100, validators=[validate_phone],
        help_text=dedent("""

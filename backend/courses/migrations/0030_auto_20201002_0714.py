...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='course',
            name='code',
            field=models.CharField(db_index=True, help_text="The course code, e.g. '120' for CIS-120.", max_length=8),
        ),
        migrations.AlterField(
            model_name='course',
            name='department',
            field=models.ForeignKey(help_text='\nThe Department object to which the course belongs, e.g. the CIS Department object\nfor CIS-120.\n', on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='courses.department'),
        ),
        migrations.AlterField(
            model_name='course',
            name='description',
        ...
        migrations.AlterField(
            model_name='course',
            name='full_code',
            field=models.CharField(blank=True, db_index=True, help_text="The dash-joined department and code of the course, e.g. 'CIS-120' for CIS-120.", max_length=16),
        ),
        migrations.AlterField(
            model_name='course',
            name='prerequisites',
            field=models.TextField(blank=True, help_text="Text describing the prereqs for a course, e.g. 'CIS 120, 160' for CIS-121."),
        ),
        migrations.AlterField(
            model_name='course',
            name='primary_listing',
            field=models.ForeignKey(blank=True, help_text='\nThe primary Course object with which this course is crosslisted (all crosslisted courses\nhave a primary listing). The set of crosslisted courses to which this course belongs can\nthus be accessed with the related field listing_set on the primary_listing course.\n', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listing_set', to='courses.course'),
        ),
        migrations.AlterField(
            model_name='course',
            name='semester',
        ...
        migrations.AlterField(
            ...
            name='code',
            field=models.CharField(db_index=True, help_text="The department code, e.g. 'CIS' for the CIS department.", max_length=8, unique=True),
        ),
        migrations.AlterField(
            model_name='department',
            name='name',
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(db_index=True, help_text='The full name of the instructor.', max_length=255, unique=True),
        ),
        migrations.AlterField(
            model_name='instructor',
            name='user',
            field=models.ForeignKey(blank=True, help_text="The instructor's Penn Labs Accounts User object.", null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='meeting',
            name='day',
            field=models.CharField(help_text='The single day on which the meeting takes place (one of M, T, W, R, or F).', max_length=1),
        ),
        migrations.AlterField(
            model_name='meeting',
            name='end',
            field=models.DecimalField(decimal_places=2, help_text='The end time of the meeting; hh:mm is formatted as hh.mm = h+mm/100.', max_digits=4),
        ),
        migrations.AlterField(
            model_name='meeting',
            name='room',
            field=models.ForeignKey(help_text='The Room object in which the meeting is taking place.', on_delete=django.db.models.deletion.CASCADE, to='courses.room'),
        ),
        migrations.AlterField(
            model_name='meeting',
            name='section',
            field=models.ForeignKey(help_text='The Section object to which this class meeting belongs.', on_delete=django.db.models.deletion.CASCADE, related_name='meetings', to='courses.section'),
        ),
        migrations.AlterField(
            model_name='meeting',
            name='start',
            field=models.DecimalField(decimal_places=2, help_text='The start time of the meeting; hh:mm is formatted as hh.mm = h+mm/100.', max_digits=4),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='requirement',
            name='school',
            field=models.CharField(choices=[('SEAS', 'Engineering'), ('WH', 'Wharton'), ('SAS', 'College')], db_index=True, help_text='\nWhat school this requirement belongs to, e.g. \'SAS\' for the SAS \'Formal Reasoning Course\'\nrequirement satisfied by CIS-120. Options and meanings:\n<table width=100%><tr><td>"SEAS"</td><td>"Engineering"</td></tr><tr><td>"WH"</td><td>"Wharton"</td></tr><tr><td>"SAS"</td><td>"College"</td></tr></table>', max_length=5),
        ),
        migrations.AlterField(
            model_name='requirement',
            name='semester',
        ...
        migrations.AlterField(
            model_name='room',
            name='name',
            field=models.CharField(help_text="The room name (optional, empty string if none), e.g. 'Wu and Chen Auditorium'.", max_length=80),
        ),
        migrations.AlterField(
            model_name='room',
            name='number',
            field=models.CharField(help_text='The room number, e.g. 101 for Wu and Chen Auditorium in Levine.', max_length=5),
        ),
        migrations.AlterField(
            model_name='section',
            name='activity',
            field=models.CharField(choices=[('CLN', 'Clinic'), ('DIS', 'Dissertation'), ('IND', 'Independent Study'), ('LAB', 'Lab'), ('LEC', 'Lecture'), ('MST', 'Masters Thesis'), ('REC', 'Recitation'), ('SEM', 'Seminar'), ('SRT', 'Senior Thesis'), ('STU', 'Studio'), ('***', 'Undefined')], db_index=True, help_text='The section activity, e.g. \'LEC\' for CIS-120-001 (2020A). Options and meanings: <table width=100%><tr><td>"CLN"</td><td>"Clinic"</td></tr><tr><td>"DIS"</td><td>"Dissertation"</td></tr><tr><td>"IND"</td><td>"Independent Study"</td></tr><tr><td>"LAB"</td><td>"Lab"</td></tr><tr><td>"LEC"</td><td>"Lecture"</td></tr><tr><td>"MST"</td><td>"Masters Thesis"</td></tr><tr><td>"REC"</td><td>"Recitation"</td></tr><tr><td>"SEM"</td><td>"Seminar"</td></tr><tr><td>"SRT"</td><td>"Senior Thesis"</td></tr><tr><td>"STU"</td><td>"Studio"</td></tr><tr><td>"***"</td><td>"Undefined"</td></tr></table>', max_length=50),
        ),
        migrations.AlterField(
            model_name='section',
        ...
        migrations.AlterField(
            model_name='section',
            name='capacity',
            field=models.IntegerField(default=0, help_text='The number of allowed registrations for this section, e.g. 220 for CIS-120-001 (2020A).'),
        ),
        migrations.AlterField(
            model_name='section',
            name='code',
            field=models.CharField(db_index=True, help_text="The section code, e.g. '001' for the section CIS-120-001.", max_length=16),
        ),
        migrations.AlterField(
            model_name='section',
            name='course',
        ...
        migrations.AlterField(
            model_name='section',
            name='credits',
            field=models.DecimalField(blank=True, db_index=True, decimal_places=2, help_text='The number of credits this section is worth.', max_digits=3, null=True),
        ),
        migrations.AlterField(
            model_name='section',
            name='full_code',
        ...
        migrations.AlterField(
            model_name='section',
            name='instructors',
            field=models.ManyToManyField(help_text='The Instructor object(s) of the instructor(s) teaching the section.', to='courses.Instructor'),
        ),
        migrations.AlterField(
            model_name='section',
            name='meeting_times',
        ...
        migrations.AlterField(
            model_name='section',
            name='restrictions',
            field=models.ManyToManyField(blank=True, help_text='All registration Restriction objects to which this section is subject.', to='courses.Restriction'),
        ),
        migrations.AlterField(
            model_name='section',
            name='status',
            field=models.CharField(choices=[('O', 'Open'), ('C', 'Closed'), ('X', 'Cancelled'), ('', 'Unlisted')], db_index=True, help_text='The registration status of the section. Options and meanings: <table width=100%><tr><td>"O"</td><td>"Open"</td></tr><tr><td>"C"</td><td>"Closed"</td></tr><tr><td>"X"</td><td>"Cancelled"</td></tr><tr><td>""</td><td>"Unlisted"</td></tr></table>', max_length=4),
        ),
        migrations.AlterField(
            model_name='statusupdate',
            name='alert_sent',
            field=models.BooleanField(help_text='Was an alert was sent to a User as a result of this status update?'),
        ),
        migrations.AlterField(
            model_name='statusupdate',
            name='new_status',
            field=models.CharField(choices=[('O', 'Open'), ('C', 'Closed'), ('X', 'Cancelled'), ('', 'Unlisted')], help_text='The new status code (to which the section changed). Options and meanings: <table width=100%><tr><td>"O"</td><td>"Open"</td></tr><tr><td>"C"</td><td>"Closed"</td></tr><tr><td>"X"</td><td>"Cancelled"</td></tr><tr><td>""</td><td>"Unlisted"</td></tr></table>', max_length=16),
        ),
        migrations.AlterField(
            model_name='statusupdate',
            name='old_status',
            field=models.CharField(choices=[('O', 'Open'), ('C', 'Closed'), ('X', 'Cancelled'), ('', 'Unlisted')], help_text='The old status code (from which the section changed). Options and meanings: <table width=100%><tr><td>"O"</td><td>"Open"</td></tr><tr><td>"C"</td><td>"Closed"</td></tr><tr><td>"X"</td><td>"Cancelled"</td></tr><tr><td>""</td><td>"Unlisted"</td></tr></table>', max_length=16),
        ),
        migrations.AlterField(
            model_name='statusupdate',
            name='section',
            field=models.ForeignKey(help_text='The section which this status update applies to.', on_delete=django.db.models.deletion.CASCADE, to='courses.section'),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='email',
            field=models.EmailField(blank=True, help_text='The email of the User. Defaults to null.', max_length=254, null=True),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='phone',
            field=models.CharField(blank=True, help_text='\nThe phone number of the user. Defaults to null.\nThe phone number will be stored in the E164 format, but any form parseable by the\n[phonenumbers library](https://pypi.org/project/phonenumbers/)\nwill be accepted and converted to E164 format automatically upon saving.\n', max_length=100, null=True, validators=[courses.models.UserProfile.validate_phone]),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='user',
            field=models.OneToOneField(help_text='The User object to which this User Profile object belongs.', on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL),
        ),
    ]

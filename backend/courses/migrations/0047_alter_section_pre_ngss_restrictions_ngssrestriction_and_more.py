...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, help_text='All pre-NGSS (deprecated since 2022C) registration NGSSRestriction objects to which this section is subject. This field will be empty for sections in 2022C or later.', related_name='sections', to='courses.prengssrestriction'),
        ),

...
from courses.models import Course, Meeting, Section
from courses.serializers import CourseListSerializer, SectionDetailSerializer, CourseDetailSerializer
...
class AutomaticCourseScheduler(APIView):
    ...
    def get(self, request, *args, **kwargs):
        desired = Course.objects.filter(
            full_code="FNCE-1010",semester=get_current_semester()).all()

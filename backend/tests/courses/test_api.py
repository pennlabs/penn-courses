...
class CommentsTestCase(TestCase):
    def setUp(self):
        ...
        self.course, self.section = create_mock_data(self._SECTION_CODE, TEST_SEMESTER)
    ...
    def upvote(self, username, comment_id):
        ...
        self.client.post(
            ...
            {"vote_type": "upvote", "comment_id": comment_id}
        )
        self.client.logout()
    ...
    def downvote(self, username, comment_id):
        ...
        self.client.post(
            reverse("comment-vote"),
            {"vote_type": "downvote", "comment_id": comment_id}
        )
        self.client.logout()

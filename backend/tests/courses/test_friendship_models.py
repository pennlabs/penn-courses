...
class FriendshipModelTest(TestCase):
    ...
    def test_basic_friendship(self):
        ...
        make_friends = self.client1.post(
            reverse("friendship"), {"pennkey": u2.username.upper()}
        )
    ...
    def test_none_delete(self):
        ...
        delete_friends = self.client2.delete(
            reverse("friendship"), {"pennkey": u1.username}
        )
    ...
    def test_basic_friendship_accept(self):
        ...
        make_friends = self.client2.post(
            reverse("friendship"), {"pennkey": u1.username}
        )
        self.assertEquals(make_friends.status_code, 201)

        make_friends2 = self.client1.post(
            reverse("friendship"), {"pennkey": u2.username}
        )
    ...
    def test_basic_friendship_reject(self):
        ...
        self.assertEquals(make_friends.status_code, 201)
        make_friends2 = self.client1.delete(
            reverse("friendship"), {"pennkey": u2.username}
        )
        self.assertEquals(make_friends2.status_code, 200)
    ...
    def test_basic_friendship_delete_request(self):
        ...
        remove_friend = self.client1.delete(
            reverse("friendship"), {"pennkey": u2.username}
        )
    ...
    def test_basic_friendship_remove(self):
        ...
        make_friends2 = self.client2.delete(
            reverse("friendship"), {"pennkey": u1.username}
        )
    ...
    def test_basic_null_delete(self):
        u1 = self.u1
        make_friends = self.client2.delete(
            reverse("friendship"), {"pennkey": u1.username}
        )
    ...
    def test_duplicate_accepts(self):
        ...
        self.assertEquals(
            make_friends2.status_code, 409
        )  # duplicate accepted friendship
    ...
    def test_duplicate_rejects(self):
        ...
        make_friends = self.client1.delete(
            reverse("friendship"), {"pennkey": u2.username}
        )
        ...
        self.assertEquals(
            make_friends.status_code, 409
        )  # already rejected friendship request
    ...
    def test_friendship_after_rejection(self):
        ...
        make_friends3 = self.client1.post(
            reverse("friendship"), {"pennkey": u2.username}
        )
    ...
    def test_get_friendship_multiple(self):
        ...
        make_friends = self.client2.post(
            reverse("friendship"), {"pennkey": u3.username}
        )
        self.assertEquals(make_friends.status_code, 201)
        make_friends = self.client3.post(
            reverse("friendship"), {"pennkey": u2.username}
        )
        self.assertEquals(make_friends.status_code, 200)

        make_friends = self.client2.post(
            reverse("friendship"), {"pennkey": u4.username}
        )
        self.assertEquals(make_friends.status_code, 201)

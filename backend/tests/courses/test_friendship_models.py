...
class FriendshipModelTest(TestCase):
    ...
    def test_basic_friendship(self):
        ...
        make_friends = self.client1.post(friendship_url, {"friend_id": u2.id})
    ...
    def test_basic_friendship_accept(self):
        ...
        make_friends = self.client2.post(friendship_url, {"friend_id": u1.id})
        self.assertEquals(make_friends.status_code, 201)

        make_friends2 = self.client1.post(friendship_url, {"friend_id": u2.id})
    ...
    def test_basic_friendship_reject(self):
        ...
        make_friends = self.client2.post(friendship_url, {"friend_id": u1.id})
        self.assertEquals(make_friends.status_code, 201)
        make_friends2 = self.client1.delete(friendship_url, {"friend_id": u2.id})
        self.assertEquals(make_friends2.status_code, 200)
    ...
    def test_basic_friendship_delete_request(self):
        ...
        remove_friend = self.client1.delete(friendship_url, {"friend_id": u2.id})
    ...
    def test_basic_friendship_remove(self):
        ...
        make_friends2 = self.client2.delete(friendship_url, {"friend_id": u1.id})
    ...
    def test_duplicate_rejects(self):
        ...
        make_friends = self.client1.delete(friendship_url, {"friend_id": u2.id})
    ...
    def test_friendship_after_rejection(self):
        ...
        make_friends3 = self.client1.post(friendship_url, {"friend_id": u2.id})
    ...
    def test_get_friendship_multiple(self):
        ...
        make_friends = self.client2.post(friendship_url, {"friend_id": u3.id})
        self.assertEquals(make_friends.status_code, 201)
        make_friends = self.client3.post(friendship_url, {"friend_id": u2.id})
        self.assertEquals(make_friends.status_code, 200)

        make_friends = self.client2.post(friendship_url, {"friend_id": u4.id})
        self.assertEquals(make_friends.status_code, 201)

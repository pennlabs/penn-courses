...
class RecomputeCourseCreditsTestCase(TestCase):
    ...
    """
    def setUp(self):
        self.course, self.section1, _, _ = get_or_create_course_and_section("CIS-120-001", TEST_SEMESTER)
        ...
        self.course2, self.section3, _, _ = get_or_create_course_and_section("CIS-160-001", TEST_SEMESTER)
        self.section3.credits = 1.50
        self.section3.save()

        self.course3, self.section4, _, _ = get_or_create_course_and_section("CIS-1210-001", TEST_SEMESTER)

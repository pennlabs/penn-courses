    ...
    return {
        ...
        'NATSCI': {
            ...
            True: [
                ...
                {'EAS': [210]},
                {'GEOL': None},
                # TODO: 109, 130 and any course above 200
                {'MSE': [221]},
                {'MEAM': [110, 147]},
                {'PHYS': None}
                # TODO: PHYS 050, 051, 093, 094, 140, 141, and courses numbered 150 and above**, except 314, 360 and 500
...
def get_requirements():
    ...
    for req, classes in bulk.items():
        reqs[req] = []
        for satisfies, lines in classes.items():
            for line in lines:
                dept, course_ids = list(line.items())[0]

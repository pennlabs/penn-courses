...
easy to enter by hand. See each individual requirement's page for details, check for updates
~1/year, and if anyone happens to be an NLP legend and want to try and parse these pages, 100% go
for it.
"""
    ...
    return {
        ...
        "MATH": {
            True: {
                "CIS": [160, 261, 262],
                "EAS": [205],
                # Note that None as a value here means that ALL courses in this department count by
                # default.
                "ENM": None,
                "ESE": [301, 302, 402],
                "MATH": None,

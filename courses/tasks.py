...
def load_requirements(school=None, semester=None, requirements=None):
    """
    :param school: School to load requirements from. Current options are WH (Wharton) and SEAS
        (Engineering)
    :param semester: Semester to load requirements in for.
    :param requirements: If school is not specified, can input a custom requirements dict in this
        format:
    {

...
class ParseOpendataResponseTestCase(TestCase):
        ...
        "result_data": [
            {
              ...
              "course_department": "CIS",
              "course_description": "Course Desription for CIS120",
              "course_description_url": "http://www.cis.upenn.edu/~cis120/current/index.shtml",
              ...
              "department_description": "Computer and Information Sci",
              "department_url": "http://www.cis.upenn.edu/grad",
              "end_date": "2019-12-09T05:00:00Z",
              "first_meeting_days": "MWF11:00 AMLLAB10",
              ...
              "section_id_normalized": "CIS -120-001",
              "section_number": "001",
              "section_title": "Prog Lang & Tech I",
              "start_date": "2019-08-27T04:00:00Z",
              "syllabus_url": "",
              "term": "2019C",
              "term_normalized": "Fall 2019",
              "term_session": "",
              "third_party_links": []
            }
            ],
    ...
    def test_parse_response(self):
        upsert_course_from_opendata(json.loads(self.data)['result_data'][0], TEST_SEMESTER)

...
from courses.models import Course, Department, Instructor, Requirement, Section, StatusUpdate
...
class StatusUpdateTest(TestCase):
    ...
    def test_cis120(self):
        ...
        self.assertEqual(response.data[0]['request_body'], '')
    ...
    def test_cis160(self):
        ...
        self.assertEqual(response.data[0]['request_body'], 'bod')

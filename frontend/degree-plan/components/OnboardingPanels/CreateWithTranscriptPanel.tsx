    ...
    useEffect(() => {
        if (degreeID) {
            ...
            for (let semester of scrapedCourses) {
                ...
                formattedSemester.courses = semester.courses.map(
                    (course: String) => course.replace(" ", "-").toUpperCase(),
                );
                        ...
                        <FieldWrapper>
                            ...
                            {nameAlreadyExists && (
                                <ErrorText
                                    style={{
                                        color: "red",
                                        visibility: nameAlreadyExists
                                            ? "visible"
                                            : "hidden",
                                    }}
                                >
                                    A degree plan with this name already exists.

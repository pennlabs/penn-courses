...
const DropdownCopyButton = ({ copy }: { copy: () => void }) => ({ copy }: { copy: () => void }) => (
    <Icon
        onClick={(e) => {
            copy();
            e.stopPropagation();
...
const DropdownSetPrimaryButton = ({ setPrimary }: { setPrimary: () => void }) => () => (
    <Icon
        onClick={(e) => {
            setPrimary();
            e.stopPropagation();
...
const DropdownDownloadButton = ({ download }: { download: () => void }) => (
    <Icon
        onClick={(e) => {
            download();
            e.stopPropagation();
...
const DropdownButton = ({
    ...
    >
        ...
        <ScheduleOptionsContainer>
            {hasFriends && <DropdownSetPrimaryButton setPrimary={setPrimary}></DropdownSetPrimaryButton>}
            {rename && <DropdownRenameButton rename={rename}></DropdownRenameButton>}
            <DropdownCopyButton copy={copy}></DropdownCopyButton>
            {/*<DropdownDownloadButton download={download}></DropdownDownloadButton>*/}

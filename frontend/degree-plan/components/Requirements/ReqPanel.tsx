...
const ReqPanel = ({setModalKey, setModalObject, activeDegreeplan, isLoading}: ReqPanelProps) => {
  ...
  // Callback that returns the rules a courses is expected to fulfill. This list of expected double counts should be a superset of the actual double counts
  // (and a superset that is as tight as possible to the actual double counts)
  const expectedDoubleCounts = useCallback(() => {  // a flat list of rules

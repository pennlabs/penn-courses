...
const BrowsePage = () => {
   ...
   const { data: autocompleteData = null } = useQuery({
   ...
   useEffect(() => {
       // Debounced so continuous inputs (e.g. dragging a rating slider, which
       // fires onInput on every pointermove) don't call history.push() fast
       // enough to hit the browser's pushState rate limit.

  ...
  return (
    <div className={cn("mx-[10%]")}>
      ...
      <p>
        ...
        updated the site again to continue providing you with the best insights
        on courses. In 2021, we migrated the site over to a shared backend with{" "}
        <a
          target="_blank"
        ...
        updates). We hope to continue updating and improving Penn Course Review
      ...
      <p>
        ...
        University of Pennsylvania. PCR has a long history of being a valuable
        and influential guide for course selection.
      </p>
      <p>
      ...
      <p>
        Interested in building something using the Penn Courses API? Check our
        our{" "}
        <a
          target="_blank"
          rel="noopener noreferrer"
      ...
      <Image alt="Penn Labs" src="/image/labs.png" width={100} height={100} />
